...
d3.csv("df_all_data_w_decades.csv")
  .then(function (musicData) {
    ...
    var artistimages = {
      ...
      "Lana Del Ray":
        "https://eventticketboss.com/sites/default/files/styles/focal_cropped_thumbs/public/3.jpg?itok=VfKkEJcx",
      "One Direction":
      ...
      "Lata MangeshKar":
        "https://i2.wp.com/odishabytes.com/wp-content/uploads/2019/09/Lata.jpeg?fit=360%2C360&ssl=1",
      "Dean Martin":
